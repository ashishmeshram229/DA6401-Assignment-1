...
# ── EXACT names the autograder calls ─────────────────────────────────────────

def parse_arguments():
    """Called by autograder as inference.parse_arguments()"""
...
def load_model(model_path):
    """Called by autograder as inference.load_model(path). Returns weights dict."""
...
def main():
    ...
    # Load architecture from best_config.json so it always matches saved model
